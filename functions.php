            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Submit Media Query</a>
                        </li>
						<li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> News<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">News</a>
                                </li>
                                <li>
                                    <a href="morris.html">News Chinese</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Post A Job</a>
                                </li>
                                <li>
                                    <a href="morris.html">Manage Jobs</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
