<div id="job-manager-job-dashboard">
	...
	<table class="job-manager-jobs">
		...
		<tbody>
			<?php if ( ! $jobs ) : ?>
				<tr>
					<td colspan="6"><?php _e( '<div align=center><font color=red><strong>&nbsp;&nbsp; You do not have any active listings. Please <a href=\'https://www.pitch.asia/post-a-job/\'>click here</a> to post a new job. &nbsp;&nbsp;</strong></font></div>', 'wp-job-manager' ); ?></td>
				</tr>
			<?php else : ?>
