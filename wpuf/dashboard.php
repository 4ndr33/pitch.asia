...
<img src="https://www.pitch.asia/wp-content/uploads/mymediaqueries-banner.png" border="0">
                    ...
                    <td>
                        ...
                        if ( wpuf_get_option( 'enable_post_edit', 'wpuf_dashboard', 'yes' ) == 'yes' ) {
                            ...
                            if ( $post->post_status == 'pending' && $disable_pending_edit == 'on' ) {
                                ...
                                ?>
                                <!--REMOVE EDIT FEATURE<a href="<?php echo wp_nonce_url( $url, 'wpuf_edit' ); ?>"><?php _e( 'Edit', 'wpuf' ); ?></a>-->
                                <?php
                            }
                        }
                        ?>
                        ...
                        if ( wpuf_get_option( 'enable_post_del', 'wpuf_dashboard', 'yes' ) == 'yes' ) {
                            ...
                            ?>
                            <a href="<?php echo wp_nonce_url( $del_url, 'wpuf_del' ) ?>" onclick="return confirm('Are you sure you want to delete?');"><span style="color: red;"><?php _e( 'Delete', 'wpuf' ); ?></span></a>
                        <?php } ?>
                    </td>
                </tr>
                <?php
    ...
    printf( '<div class="wpuf-message">' . __( '<div align="center"><img src="https://www.pitch.asia/wp-content/uploads/exclamation-octagon-icon.png" border="0"> <strong>You have no %s currently posted. Do you need an expert source?</strong><br /><br /><a href="https://www.pitch.asia/mediaquery/" class="button-white">Submit Media Query</a></div>', 'wpuf' ) . '</div>', $post_type_obj->label );
